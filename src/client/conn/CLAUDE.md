...
Public client connection builders and connection futures for HTTP/1 and HTTP/2.
...
- `http1.rs` - Rust source file for this module or example.
- `http2.rs` - Rust source file for this module or example.
...
- Parent context: `../../../src/client/CLAUDE.md`
