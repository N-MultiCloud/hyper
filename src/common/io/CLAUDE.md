...
I/O adapter utilities for runtime compatibility and rewind behavior.
...
- `compat.rs` - Rust source file for this module or example.
- `mod.rs` - Module root that wires sibling files into the Rust module tree.
- `rewind.rs` - Rust source file for this module or example.
...
- Parent context: `../../../src/common/CLAUDE.md`
