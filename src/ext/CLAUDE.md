...
HTTP extension types for informational responses and HTTP/1 reason phrase compatibility.
...
- `h1_reason_phrase.rs` - Rust source file for this module or example.
- `informational.rs` - Rust source file for this module or example.
