...
Internal HTTP protocol implementations. This is the core state machine layer for HTTP/1
and HTTP/2.

## Direct Subdirectories

- `h1/` - HTTP/1 connection state, decoding, encoding, dispatch, role-specific behavior, and I/O integration.
- `h2/` - HTTP/2 client/server integration through the h2 crate, ping handling, and upgrade support.
