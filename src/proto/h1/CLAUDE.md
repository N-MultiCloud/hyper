...
HTTP/1 connection state, decoding, encoding, dispatch, role-specific behavior, and I/O
integration.

## Direct Subdirectories

- No tracked child directories.

## Key Files

- `conn.rs` - Rust source file for this module or example.
- `decode.rs` - Rust source file for this module or example.
- `dispatch.rs` - Rust source file for this module or example.
- `encode.rs` - Rust source file for this module or example.
- `io.rs` - Rust source file for this module or example.
- `mod.rs` - Module root that wires sibling files into the Rust module tree.
- `role.rs` - Rust source file for this module or example.
...
- Parent context: `../../../src/proto/CLAUDE.md`
