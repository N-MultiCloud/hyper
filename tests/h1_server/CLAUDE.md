...
HTTP/1 server-focused integration tests and fixtures.
...
- `fixture.rs` - Rust source file for this module or example.
...
- Parent context: `../../tests/CLAUDE.md`
